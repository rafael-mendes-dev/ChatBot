...
public class GeminiService : IGeminiService
{
    ...
    {
        var apiKey = configuration["GeminiSettings:ApiKey"] ?? throw new ArgumentException("ApiKey não configurado em appsettings.json.");
    ...
    public async Task<string> GetChatbotResponseAsync(string botContext, List<Message> chatHistory, string userMessage)
    {
        try
        {
            ...
            //Adicione o contexto do bot, se fornecido
